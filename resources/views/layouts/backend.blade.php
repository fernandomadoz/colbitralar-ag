...
<head>
  ...
  <title>Colbritralar | Auto-Gestión</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo env('PATH_PUBLIC')?>" class="logo">
      ...
      <i class="fa fa-certificate"></i> Colbitralar</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if (in_array($nivel_de_acceso, $permiso_afiliado)) { ?>
